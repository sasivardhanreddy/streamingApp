...
/**
 * Resizable-array implementation of the {@link com.koushikdutta.async.Deque} interface.  Array
                           ...
                           implements Deque<E>, Cloneable, java.io.Serializable
{
     ...
     *
     * @param e the element to add
     * @return <tt>true</tt> (as specified by {@link com.koushikdutta.async.Deque#offerFirst})
     * @throws NullPointerException if the specified element is null
     */
     ...
     *
     * @param e the element to add
     * @return <tt>true</tt> (as specified by {@link com.koushikdutta.async.Deque#offerLast})
     * @throws NullPointerException if the specified element is null
     */
